...
console.log(`"${letter}" é a ${index} letra do meu nome. `))
...
function filter(array, func) {
  // Crie um novo array para armazenar os itens filtrados
  let newArray = [];

  function filterItem  (item, index, array)  {
...
console.log(filter([0,2,3], item => item));
