...
////const capitalizeddName= [...firstName.slice(0,1).toUpperCase(),...firstName.slice(1)].join('') 
////const capitalizedName = [...firstName[0].toUpperCase(),...firstName.slice(1)].join('') 
//
////console.log(capitalizeddName);
...
//}
//
//const sumArayItems = item => {
//  accumulator += item
//}
//
//forEach(oddNumbers, logMessage )
//forEach(oddNumbers, sumArayItems )
...
const manipulateSlideClass = (correctSlideIndex)=> {
...
nextButton.addEventListener('click', () => {
  const correctSlideIndex =
    currentSlideIndex === lastSlideIndex
      ...
      manipulateSlideClass(correctSlideIndex)
})
